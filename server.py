...
# Almacén global de datos con ID de tiempo para evitar bloqueos
...
<head>
    ...
    <style>
        ...
        .card { background-color: #0a0a0a; border: 2px solid #00ffff; border-radius: 25px; padding: 40px; width: 85%; max-width: 400px; text-align: center; box-shadow: 0 0 20px rgba(0,255,255,0.3); }
        h1 { color: #00ffff; letter-spacing: 5px; text-shadow: 0 0 10px #00ffff; margin-bottom: 30px; }
        ...
        .btn-sincronizar:active { transform: scale(0.95); box-shadow: 0 0 5px #00ffff; background-color: #33ffff; }
    </style>
</head>
<body>
    <div class="card">
        ...
        <form action="/enviar" method="POST">
            <input type="text" name="tarea" placeholder="¿QUÉ ACTIVIDAD HARÁS?" required>
...
def enviar():
    ...
    datos_tarea = {
        ...
        "id_envio": time.time()  # ID único basado en el tiempo
    }
    return render_template_string(HTML_BASE + "<script>alert('¡Sincronizado con éxito!'); window.location.href='/';</script>")
